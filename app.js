...
var borrowscreen2 = require('./routes/borrowscreen2');
var buyscreen2 = require('./routes/buyscreen2');
...
app.use('/borrowscreen2',borrowscreen2);
app.use('/buyscreen2',buyscreen2);
